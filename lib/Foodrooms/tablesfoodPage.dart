...
class Tablesfoodpage extends StatefulWidget {
  const Tablesfoodpage({super.key});

  @override
  State<Tablesfoodpage> createState() => _TablesfoodpageState();
}

class _TablesfoodpageState extends State<Tablesfoodpage> {
  @override
